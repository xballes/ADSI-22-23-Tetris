...
public class Reproductor {
	...
	public void empezarMusica(int pId) {
		...
		/* Pre: int en dominio de array archivos. Dicho int apunta al nombre de la cancion que se desea reproducir en la array archivos. El .wav que tiene dicho nombre existe en la carpeta de recursos "materiales"
		   ...
		   Post: Se empezar� a reproducir la m�sica en loop infinito hasta que se le llame al metodo de pausar o terminar   
	...
	/*   Pre: Hay m�sica en reproducci�n, ya que el atributo clip no es null
 	     Post: Se pausa la m�sica, pero no se pierde el puntero a la reproducci�n, llamando a despausarMusica() ser� posible continuar la reproduccion
