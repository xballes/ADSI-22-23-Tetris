...
public class GestorUsuariosTest {
	...
	public void testRegistrar() {
		// Post del mñtodo: 0 si correcto, 1 si demasiado largos o corto, 2 si username ya existente, 3 si mail ya existente, 4 si caracteres invalidos
		...
		assertTrue(this.gestor.registrar("32423ñ$%$ñ%$ñEWR", "Psdd", "Mail1") == 4);
		assertTrue(this.gestor.contarUsuariosConEseNomnbre("Per6") == 0);
		
		assertTrue(this.gestor.registrar("32423ñ$%$ñ%$ñEWR", "Psdd", "@#@#dsfsdk%%%$$%ñ%ñ%") == 4);
		assertTrue(this.gestor.contarUsuariosConEseNomnbre("Per6") == 0);
	...
	public void testVerificarUsuario() {
		// Post del mñtodo: True si correcto, false si incorrecto
		...
		assertTrue(!this.gestor.verificarUsuario("Peñ$$ñ%ñ$%$ñ%ñ$r1", "Pass"));
	...
	public void testObtContraseña() {
		...
		// Post del mñtodo: Si coinicide, la string con la contraseña, else, null
		...
		assertTrue(this.gestor.obtContraseña("ñ$ñ%ñ$%ñ$%ñ$ñ$ñ$") == null);
	...
	public void testBorrarUsuario() {
		// Post del mñtodo: True si se borrñ alguien, false si no. Nota: El usuario administrador tiene inmunidad al borrado
		...
		assertTrue(this.gestor.contarUsuariosConEseNomnbre("ñ$$ñ$ñ~#@#~@") == 0);
		assertTrue(!this.gestor.borrarUsuario("ñ$$ñ$ñ~#@#~@"));
		assertTrue(this.gestor.contarUsuariosConEseNomnbre("ñ$$ñ$ñ~#@#~@") == 0);
