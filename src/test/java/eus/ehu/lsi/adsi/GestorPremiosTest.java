...
public class GestorPremiosTest {
	...
	public void testConsultarPremios() {
		...
		gestorU.registrar("pablo", "hdh", "dhdh");
		...
		assertTrue(this.gestorU.obtenerPremios("pepe").length==0);
		assertTrue(this.gestorU.obtenerPremios("pablo").length==1);
		assertTrue(this.gestorP.tieneElPremio("pablo", 1));
		...
		assertTrue(this.gestorU.obtenerPremios("pepe").length==0);
		assertTrue(this.gestorU.obtenerPremios("pablo").length==3);

		assertTrue(this.gestorP.tieneElPremio("pablo", 2));
		assertTrue(this.gestorP.tieneElPremio("pablo", 3));
		assertTrue(this.gestorP.tieneElPremio("pablo", 1));
		...
		assertTrue(this.gestorP.tieneElPremio("pepe", 1));
		assertTrue(this.gestorP.tieneElPremio("pepe", 0));
		assertTrue(this.gestorP.tieneElPremio("pepe", 2));
