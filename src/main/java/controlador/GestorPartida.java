...
public class GestorPartida {
	...
	public void guardarPartida(int[][] matriz, String usuario, int numCols, Timestamp fecha, int puntuacion, boolean tetris) {
		 ...
		 *      usuario --> nombre del usuario jugando, estñ en BD
		 ...
		 *      tetris --> ñPerformñ al menos un tetris durante el tiempo que ha estado jugando desde que cargo/inicio partida?
		...
		// Calcular el nivel, deducible por nñmero de columnas de la matriz (mñs columnas --> mñs dificil)
	...
	public String mostrarPartidas(String pNombreUsuario) {
		...
		/* Pre: Usuario en BD
		 * Post: String en formato JSON con la informaciñn de las partidas sin acabar del jugador, esta es:
	...
	private String transformarFormato(String entrada) {
		...
		// El mñtodo sirve para que basado en el formato de fecha dado por JSON se pueda generar despues en un objeto Timestamp
