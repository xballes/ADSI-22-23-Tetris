...
public class RecuperoContraseña extends JFrame implements Ventana {
	...
	private RecuperoContraseña () {
		...
		this.titulo = new JLabel("Recupero Contrase�a", SwingConstants.CENTER);
		...
		for (int i = 0; i != 2; i++) {
			String val = null;
			switch (i) {
			case 0: val = "Recuperar Contrase�a"; break;
	...
	private class Accion1 implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (cont == null) {
				...
				PopUp.visibilizar("��xito! Tu contrase�a es: "+cont, puntero);
